...
현재 스프링에서 @Builder를 통해 자동으로 Builder Pattern에 맞는 Builder 클래스를 생성해주는 기능을 제공하고 있습니다.
...
각각의 알고리즘을 독립적인 클래스로 구현하기 때문에 코드의 재사용이 간편하고, 다른 알고리즘으로 교체하기가 쉬워 애플리케이션의 유연성과 확장성을 증가시킬 수 있습니다.
...
### [Q] MVC 패턴 장단점
#
각 역할이 분리되어 있으므로, 가독성이 좋고, 변경이 발생해도 다른 역할에 영향을 미치지 않아 수정이 쉽고 재사용을 편리하게 할 수 있습니다.
